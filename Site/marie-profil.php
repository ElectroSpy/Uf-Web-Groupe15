...
<head>
    ...
    <link rel="stylesheet" href="Css/Style-marie.css">
    ...
    <main>
        <div id="txt">
            <ul>
                ...
                <li><a href="CV-marie.php">Cv</a></li>
            </ul>
            <?php $sql =  'SELECT Prenom, Nom, Metier, Linkedin, Github, Mail FROM utilisateur, contact WHERE contact.ID_User=utilisateur.ID_User AND utilisateur.ID_User = 3';
