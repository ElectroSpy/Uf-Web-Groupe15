...
<head>
    ...
    <body>
        ...
        <div class="contact">
            ...
            <?php $sql =  'SELECT Prenom, Nom, Metier, Tel, Age, Permis, Linkedin, Github, Mail, No_rue, Nom_rue, CodePostal, Ville FROM utilisateur, contact WHERE contact.ID_User=utilisateur.ID_User AND utilisateur.ID_User = 1';
        ...
        <div class="formation">
            <h3>Formation</h3>
            <?php $sql =  'SELECT Date_debut, Nom_ecole, Ville_ecole, Diplome FROM Formation WHERE ID_formation = 6';
                $requete = $pdo->query($sql);
                while($row=$requete->fetch()){
            ?>
            <p><?php echo $row['0'];?></p>
            ...
            <p><?php echo $row['3'];}?></p>
            <br>
            <?php $sql =  'SELECT Date_debut, Date_fin, Nom_ecole, Ville_ecole, Diplome FROM Formation WHERE ID_formation = 5';
                $requete = $pdo->query($sql);
                while($row=$requete->fetch()){
            ?>
            ...
            <p><?php echo $row['4'];}?></p>
            <br>
            <?php $sql =  'SELECT Date_debut, Date_fin, Nom_ecole, Ville_ecole, Diplome FROM Formation WHERE ID_formation = 4';
                $requete = $pdo->query($sql);
                while($row=$requete->fetch()){
            ?>
            <p><?php echo $row['0'];?>-<?php echo $row['1'];?></p>
        ...
        <div class="exp">
            <h3>Experiences</h3>
            <?php $sql =  'SELECT Date_debut, Date_fin, Entreprise, Poste FROM exp_pro WHERE ID_xp = 6';
                $requete = $pdo->query($sql);
                while($row=$requete->fetch()){
            ?>
            <p><?php echo $row['0'];?>-<?php echo $row['1'];?></p>
            ...
            <p><?php echo $row['3'];}?></p>
            <br>
            <?php $sql =  'SELECT Date_debut, Date_fin, Entreprise, Poste FROM exp_pro WHERE ID_xp = 5';
                $requete = $pdo->query($sql);
                while($row=$requete->fetch()){
            ?>
            <p><?php echo $row['0'];?>-<?php echo $row['1'];?></p>
            ...
            <p><?php echo $row['3'];}?></p>
            <br>
            <?php $sql =  'SELECT Date_debut, Date_fin, Entreprise, Poste FROM exp_pro WHERE ID_xp = 4';
                $requete = $pdo->query($sql);
                while($row=$requete->fetch()){
            ?>
            <p><?php echo $row['0'];?>-<?php echo $row['1'];?></p>
